...
namespace PedagogyPrime.Persistence.Migrations
{
    ...
    [Migration("20231130165419_AddedCoverageEntityAndCourseVisibilitiy")]
    partial class AddedCoverageEntityAndCourseVisibilitiy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PedagogyPrime.Core.Entities.Coverage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BadWords")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PedagogyPrime.Core.Entities.Coverage", b =>
                {
                    b.HasOne("PedagogyPrime.Core.Entities.Course", "Course")
                        .WithOne("Coverage")
                        .HasForeignKey("PedagogyPrime.Core.Entities.Coverage", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
